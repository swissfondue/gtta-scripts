...
$VARIABLES{'configfile'} = 'files/nikto.conf';    ### Change if it's having trouble finding it
...
setup_dirs();
require 'files/plugins/nikto_core.plugin';
nprint("T:" . localtime($COUNTERS{'scan_start'}) . ": Starting", "d");
require 'files/plugins/nikto_single.plugin';
require 'files/plugins/LW2.pm';
